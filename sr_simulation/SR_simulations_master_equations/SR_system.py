...
class SR_system:
    ...
    def create_time_evolution(self, t_sim):
        """
...
if __name__ == '__main__':
    ...
    # CL_m_max.create_time_evolution(20 * ntu * SR_m_0.natural_time_unit)
    # CL_m_0.create_time_evolution(20 * ntu * SR_m_0.natural_time_unit)
